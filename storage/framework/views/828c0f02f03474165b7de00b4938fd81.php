...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="registration">
        <?php echo csrf_field(); ?>
        <div>
            <div>
                <div class="row mb-3">
...
unset($__errorArgs, $__bag); ?>"
                               name="surname" value="<?php echo e(old('surname')); ?>" required autocomplete="surname" autofocus
                               placeholder="<?php echo e(__('Surname')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    <label for="picture" class=""><?php echo e(__('Picture')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                               name="picture" value="<?php echo e(old('picture')); ?>" autocomplete="picture" autofocus
                               placeholder="<?php echo e(__('Surname')); ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation"
                               required autocomplete="new-password" placeholder="<?php echo e(__('Confirm Password')); ?>">
                    </div>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="select">
                    <select name="group" id="group">
                        ...
                        <option value="ИСП-320">ИСП-320</option>
...
<?php echo $__env->make('layouts.PAKH', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\ПАК\PAK-laravel\project-PAK\resources\views/auth/register.blade.php ENDPATH**/ ?>